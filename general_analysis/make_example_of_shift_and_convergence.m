                ...
                for darker = [true, false]
                    ...
                    for do_lab = [true, false]
                        for chroma_only = [true, false]
                            ...
                            err = err .* err;
                            err = sum(err(:));
                            rmse.fmin(blc, ic, bc, mc, darkerc, labc, chromc) = sqrt(err/n);
                            ...
                            err = err .* err;
                            err = sum(err(:));
                            rmse.rigid(blc, ic, bc, mc, darkerc, labc, chromc) = sqrt(err/n);
                            ...
                            err = err .* err;
                            err = sum(err(:));
                            rmse.affinemap(blc, ic, bc, mc, darkerc, labc, chromc) = sqrt(err/n);
