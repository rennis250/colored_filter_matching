                ...
                for maskc = 1:num_masks
                    ...
                    for idx = idxs
                        ...
                        if any(expc == filter_exps)
                            ...
                            no_dark_obj_mask = filter_idxs;
                            no_dark_obj_mask(dark_pxs) = false;
                            no_dark_bkgd_mask = ~filter_idxs;
                            no_dark_bkgd_mask(dark_pxs) = false;
                            
                            wplab = wp(lab, no_dark_bkgd_mask, no_dark_obj_mask);
                            wplab_top5 = wp_top_5(lab, no_dark_bkgd_mask, no_dark_obj_mask, xyz);
                            [gwdkl, ~] = gw_sd(dkl, no_dark_bkgd_mask, no_dark_obj_mask);
                            [gwlab, sdlab] = gw_sd(lab, no_dark_bkgd_mask, no_dark_obj_mask);
                            msatdkl = msat_dkl(dkl, no_dark_bkgd_mask, no_dark_obj_mask);
                            msatlab = msat_lab(lab, no_dark_bkgd_mask, no_dark_obj_mask);
                            mfreq_lab = mfreq_col(lab, no_dark_bkgd_mask, no_dark_obj_mask);
                            [lmsm, ~] = gw_sd(lms, no_dark_bkgd_mask, no_dark_obj_mask);
                            [rmc, rsd] = rmc_rsd(lms, no_dark_bkgd_mask, no_dark_obj_mask);
                        ...
                        sdL_glaven(global_counter, :) = stats_for_curr_exp(img_idx, maskc).dark_exc_sdlab(1);
                        sda_glaven(global_counter, :) = stats_for_curr_exp(img_idx, maskc).dark_exc_sdlab(2);
                        sdb_glaven(global_counter, :) = stats_for_curr_exp(img_idx, maskc).dark_exc_sdlab(3);
                        ...
                        tau_simpler_l_glaven(global_counter, :) = stats_for_curr_exp(img_idx, maskc).dark_exc_tau_simpler(1);
                        tau_simpler_m_glaven(global_counter, :) = stats_for_curr_exp(img_idx, maskc).dark_exc_tau_simpler(2);
                        tau_simpler_s_glaven(global_counter, :) = stats_for_curr_exp(img_idx, maskc).dark_exc_tau_simpler(3);
                        
                        tau_general_l_glaven(global_counter, :) = stats_for_curr_exp(img_idx, maskc).dark_exc_tau_general(1);
                        tau_general_m_glaven(global_counter, :) = stats_for_curr_exp(img_idx, maskc).dark_exc_tau_general(2);
                        tau_general_s_glaven(global_counter, :) = stats_for_curr_exp(img_idx, maskc).dark_exc_tau_general(3);
