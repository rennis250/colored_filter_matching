...
%   Copyright(c)2002-2018 Version 5.16
%     Tom Davis (tdavis@metzgerwillard.com)
%     Jeff Chang
%   Revision History:
%
%     08/28/18 - Use explicit EdgeColor. (TD)
...
if strcmpi(p1,'update'), ad=getappdata(ax,'Arrow3');    % update
  ...
  H=LocalUpdate(fig,ax,ad,sf,flag); if nargout, hn=H; end, return
end
...
%-------------------------------------------------------------------------
% Update
function H=LocalUpdate(fig,ax,ad,sf,flag)
global ColorOrder
