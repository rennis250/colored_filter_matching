basen <- "mitsuba_caustics_rgb_trans_lightest"
        ...
        <scene version="0.6.0">
            ...
            <bsdf type="diffuse" id="colored_noise">
                <texture type="bitmap" name="reflectance">
                    <string name="filename" value="images/voronoi.png"/>
			...
			<shape type="sphere">
				...
				<emitter type="area">
					<spectrum name="radiance" filename="spectra/de_brighter_illum_', illumn, '.spd"/>
				</emitter>
			</shape>

            <shape id="BigGlaven1_002-mesh_0" type="serialized">
                <bsdf type="dielectric">
                    <spectrum name="specularTransmittance" filename="spectra/', refln , '.spd"/>
                    <spectrum name="specularReflectance" filename="spectra/', refln , '.spd"/>
                </bsdf>
                <string name="filename" value="blender/curveyBoxOverhead.serialized"/>
