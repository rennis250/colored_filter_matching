colormatchPlanck <- function(spect, wlns) {
	cmfData <- read.csv('/home/me/my_docs/source_code/MATLAB/matlabHyper/ciexyz31_1.csv')
...
lassocs <- read.csv('/home/me/my_docs/source_code/MATLAB/xyYcoords.csv')
planck <- read.csv('/home/me/my_docs/source_code/MATLAB/planck.csv')

mypalette()

pdf("../figures/refl_illum_coords.pdf", width = 8, height = 8)
mypar()
...
mypoints(lightredxyy[1], lightredxyy[2], col=4, pch=16)
mypoints(lightgreenxyy[1], lightgreenxyy[2], col=5, pch=16)
mypoints(lightbluexyy[1], lightbluexyy[2], col=6, pch=16)
mypoints(lightyellowxyy[1], lightyellowxyy[2], col=7, pch=16)

mypoints(filterredxyy[1], filterredxyy[2], col=4, pch=17)
mypoints(filtergreenxyy[1], filtergreenxyy[2], col=5, pch=17)
mypoints(filterbluexyy[1], filterbluexyy[2], col=6, pch=17)
mypoints(filteryellowxyy[1], filteryellowxyy[2], col=7, pch=17)

mypoints(bluesxyy[1], bluesxyy[2], col=6, pch=8)
mypoints(yellowsxyy[1], yellowsxyy[2], col=1, pch=8)
