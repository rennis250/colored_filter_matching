...
monxyY = csvread('../calibration/exp11a.chroma.csv');
...
fns = dir('../data/exp11a/*.mat');
ims = dir('../images/exp11a/*.png');
stats = importdata(['../images/exp11a/exp11a_chrom_stats.csv'], ',', 1);
img_names = {stats.textdata{2:2:end}};
stats = stats.data;

fh = fopen('../data/exp11a_obs_data.csv', 'w');
...
for fc = 1:length(fns)
    fn = fns(fc).name;
    load(['../data/exp11a/' fn], 'data', 'subID', 'trialOrder');
