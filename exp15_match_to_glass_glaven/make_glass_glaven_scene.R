for(ld in seq(0, 1, 1/5)) {
    for(rg_mix in seq(0, 1, 1/10)) {
        for(by_mix in seq(0, 1, 1/10)) {
            ...
            <scene version="0.6.0">
                ...
                <shape id="BigGlaven1_002-mesh_0" type="serialized">
                    <bsdf type="dielectric">
                        <spectrum name="specularTransmittance" filename="../../../base_stimuli/spectra/for_3d_color_variation/ld_', as.character(ld) ,'_rg_', as.character(rg_mix) ,'_by_', as.character(by_mix) ,'.spd"/>
                    </bsdf>
                    <string name="filename" value="../../../base_stimuli/blender/curveyBoxOverhead.serialized"/>
            ...
            fileConn <- file(paste0("stimuli/scenes/white_match_scene_ld_", as.character(ld), "_rg_", as.character(rg_mix), "_yv_", as.character(by_mix), ".xml"))
